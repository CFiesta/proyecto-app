...
<body>
    ...
    <div class="product-page">
        <div class="product-images">
            <img src="{{ asset('img/ZXT-H9-Elite.webp') }}" alt="NZXT H1 Blanco" class="main-image"> <!-- asset() para la imagen -->
            <div class="thumbnail-images">
                <img src="{{ asset('img/ZXT-H9-Elite2.webp') }}" alt="Vista lateral"> <!-- asset() para la imagen -->
                <img src="{{ asset('img/ZXT-H9-Elite3.webp') }}" alt="Vista trasera"> <!-- asset() para la imagen -->
                <img src="{{ asset('img/ZXT-H9-Elite4.webp') }}" alt="Vista interior"> <!-- asset() para la imagen -->
            </div>
        </div>
        <div class="product-details">
            ...
            <div class="product-description">
                ...
                <p>Mejores térmicas: hemos abierto el panel superior para lograr una mejor eficiencia térmica. El panel perforado proporciona una mejor ventilación a medida que el aire caliente fluye a través de la parte superior del chasis.
